...
const PROBLEM_DEFINITIONS = [
    ...
    },
    {
        ...
        answerTokens: [
            AT.EXPAND_ISOTHERMAL, AT.EXPAND_ISOTHERMAL,
            AT.EXPAND_ADIABATIC, AT.EXPAND_ADIABATIC,
            AT.COMPRESS_ISOTHERMAL, AT.COMPRESS_ISOTHERMAL,
            AT.COMPRESS_ADIABATIC, AT.COMPRESS_ADIABATIC,
        ],
    },
    {
        id: 7,
